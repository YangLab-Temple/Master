...
#                             ss = choice([4.5,5.5,6.5,7.5,8.5,9.5], p=[0.02,0.05,0.07,0.11,0.2,0.55])
        ...
        if num_points != PTNUM + 1:
            ...
            try:
                ...
                tempbins = range(dr/2, radius+dr/2, dr)
                tempdensity = final[0]
                holdlist = []
                addZero = False
...
#                 DR = 15
                ...
                gui.message.set('Calculating route radius correction...')
                gui.update()
